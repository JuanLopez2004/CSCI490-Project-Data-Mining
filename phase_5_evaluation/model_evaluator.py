...
class ModelEvaluator:
    ...
    - Statistical significance testing vs hospital baseline (83.9%)
    ...
    def load_trained_models(self):
        ...
        try:
            ...
            # Logistic Regression
            if (os.path.exists(f"{self.models_dir}logistic_regression_model.joblib") and 
                os.path.exists(f"{self.models_dir}logistic_regression_scaler.joblib")):
                
                model = joblib.load(f"{self.models_dir}logistic_regression_model.joblib")
                scaler = joblib.load(f"{self.models_dir}logistic_regression_scaler.joblib")
